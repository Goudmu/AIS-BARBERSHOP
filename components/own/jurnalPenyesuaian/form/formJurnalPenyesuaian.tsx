...
const FormJurnalPenyesuaian = ({ trigger, setTrigger }: any) => {
  ...
  const submitHandler = async () => {
    ...
    if (res.ok) {
      toast({ title: "Adjust Ledger Has Created" });
      setTrigger(!trigger);
      setEntries([
        {
          id: 1,
    ...
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          <Card>
            <CardHeader>
              <CardTitle>Adjust Ledger Form</CardTitle>
              <CardDescription>
                Enter your Adjust Ledger information below.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4">
                <h2 className="text-2xl font-bold">Adjust Ledger</h2>
                ...
                <div className="grid gap-4">
                  ...
                  <div className=" text-end">
                    <Button onClick={submitHandler}>Input Adjust Ledger</Button>
                  </div>
                </div>
              </div>
            </CardContent>
...
export default FormJurnalPenyesuaian;
